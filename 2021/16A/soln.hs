...
sumVersions (Literal ver _)      = ver
sumVersions (Operation ver _ os) = (+) ver $ sum $ map sumVersions os

solve :: Case -> Soln
solve = sumVersions . fst . head . ReadP.readP_to_S parsePacket . hexStringToBinString
